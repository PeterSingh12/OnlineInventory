...
def clear_fields(category_combobox,supplier_combobox,name_entry,price_entry,discount_spinbox,quantity_entry,status_combobox):
...
def delete_product(treeview,category_combobox,supplier_combobox,name_entry,price_entry,quantity_entry,status_combobox,discount_spinbox):
    ...
    if ans:
        ...
        try:
            ...
            clear_fields(category_combobox,supplier_combobox,name_entry,price_entry,discount_spinbox,quantity_entry,status_combobox)
...
def product_form(window):
    ...
    back_button = Button(product_frame, image=back_image,bg="white", bd=0, cursor='hand2', command=lambda: product_frame.place_forget())
    ...
    clear_button = Button(button_frame, text='Clear', font=('times new roman', 14), width=8, cursor='hand2',
                     fg='white', bg='#0f4d7d',command=lambda:clear_fields(category_combobox,supplier_combobox,name_entry,price_entry,discount_spinbox,quantity_entry,status_combobox))
    ...
    treeview_frame.place(x=480,y=115,width=570,height=430)
